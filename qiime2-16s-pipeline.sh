...
# 适用: 16S 双端测序数据
# 环境: qc_preprocess (质控/剪接) + qiime2-2023.2 (核心分析)
# 数据库: silva-138-99-nb-classifier.qza
##########################################################
...
# classifiers/silva-138-99-nb-classifier.qza 需预先下载至 classifiers/ 目录
# 下载: https://pan.baidu.com/s/1FmThEjT_m7M-Zig0M34jxQ?pwd=42vv
...
# 14a. ASV/OTU 特征表 (feature-table.biom → feature-table.tsv)
...
# 14e. Alpha 多样性 (Faith PD / Shannon / Observed Features / Evenness)
qiime tools export \
