...
#      with export/ subdirectory generated by the pipeline)
#   2. Modify setwd() below to your project path, then run:
#      Rscript QIIME2_16S_visualization.R
#   3. Script reads from export/ and outputs to export/ subdirectories
#
...
# Output subdirectories (under export/, created by qiime2-16s-pipeline.sh)
output_dirs <- c(
  "export/alpha", "export/beta", "export/taxa", "export/heatmap",
  "export/faprotax", "export/picrust2", "export/feature_tables"
)
